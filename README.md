...
<p align="center">GoRestaurant na versão web é uma aplicação que exibe os pratos de comida criados e permite a criação, remoção e atualização desses pratos. A versão mobile exibe e filtra os pratos de comida e permite a criação de novos pedidos</p>
...
<p align="center">
  <img alt="Mobile" src=".github/frontend.png" width="90%">
</p>

<p align="center">Mobile</p>

<p align="center">
  <img alt="Mobile" src=".github/mobile.png" width="25%">
</p>
...
- [Node.js](https://nodejs.org)
- [Yarn](https://yarnpkg.com)
- [Ambiente de desenvolvimento](https://react-native.rocketseat.dev/) configurado
